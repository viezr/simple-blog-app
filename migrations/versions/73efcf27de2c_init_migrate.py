...
Revision ID: 73efcf27de2c
Revises:
Create Date: 2021-04-21 01:31:34.235468
...
def upgrade():
    ...
    op.create_index(
        op.f('ix_posts_time_created'),
        'posts',
        ['time_created'],
        unique=False)
    op.create_index(
        op.f('ix_posts_time_updated'),
        'posts',
        ['time_updated'],
        unique=False)
